        ...
        <main className="w-full px-6 shadow-sm flex-1 flex justify-center items-center">
            ...
            <div className="p-4 w-[600px]">
                ...
                <form onSubmit={sendEmail} className='flex flex-col gap-4'>
                    <input className={inputClassName} type="text" name="name" placeholder="Name*" required></input>
                    <input className={inputClassName} type="email" name="email" placeholder="Email*" required></input>
                    <input className={inputClassName} type="text" name="text" placeholder="Subject*" required></input>
                    <textarea className={inputClassName} name="message" placeholder="Add weight to Subject " required></textarea>
